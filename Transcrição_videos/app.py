...
if "GEMINI_API_KEY" in st.secrets:
    ...
    st.error("Configure a variável GEMINI_API_KEY nas Secrets do Streamlit.")import streamlit as st
import whisper
import tempfile
import os
import google.generativeai as genai
...
# --- FUNÇÕES DE APOIO (MODELO COM SUFIXO LATEST) ---
def gerar_resumo(texto):
    # O sufixo -latest resolve o erro 404 em muitas regiões
...
if arquivo_video:
    ...
    if st.button("🚀 Iniciar Transcrição"):
        ...
        with st.spinner("Extraindo áudio e transcrevendo..."):
            # Criação de arquivo temporário único
